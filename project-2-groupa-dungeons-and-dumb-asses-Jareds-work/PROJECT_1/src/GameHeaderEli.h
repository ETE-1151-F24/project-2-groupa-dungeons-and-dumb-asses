...
void fight(int stats[6], int floor);                                // Declaration of fight function
void MapGen(int map[5][5]);                                         // Map Generation function
void Movement(int map[5][5], int stats[6]);                        // Player movement function
std::vector<nlohmann::json> loadSpells(const std::string& filename); // Function to load spells from a file
